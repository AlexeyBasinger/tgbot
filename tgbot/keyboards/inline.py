...
change_price = InlineKeyboardButton(text='Поменять стоимость товара', callback_data='change_price')
change_amount = InlineKeyboardButton(text='Поменять количество товара', callback_data='change_amount')
